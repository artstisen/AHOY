...
PRIVACY:
None of your data is sent from AHOY! to the Internet. Placing your Pool-file on a shared/cloud synchronized drive is your sole responsibility. When you manually do a check for software updates (from the Help Menu) AHOY! will request the latest version number from the AHOY! website and match it with its own version number before asking you to visit the download page. The AHOY! event log is local and for personal/debugging purposes. The log is stored in the encrypted Pool-file.
